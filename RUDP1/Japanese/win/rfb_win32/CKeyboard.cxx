                                ...
                                rdr::U32 flags, bool down)
{
  ...
  if (vkey=='0' && (keystate[VK_SHIFT]&0x80)!=0)
  {
	  nchars = 1;
	  chars[0] = LOBYTE(XK_kana_WO);
	  chars[1] = HIBYTE(XK_kana_WO);
  }
  else if (vkey==0xdc && (keystate[VK_SHIFT]&0x80)==0)
  {
	  nchars = 1;
	  chars[0] = XK_yen;
  }
  else if (vkey==0xe2 && (keystate[VK_SHIFT]&0x80)==0)
  {
	  nchars = 1;
	  chars[0] = XK_backslash;
  }
