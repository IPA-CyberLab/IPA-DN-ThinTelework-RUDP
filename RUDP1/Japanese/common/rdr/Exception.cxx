  ...
  : Exception(s), err(err_)
{
  ...
  const char* msg = 0;
  switch (err) {
  case WSAECONNREFUSED: msg = "接続が切断されました。";       break;
  case WSAETIMEDOUT:    msg = "通信がタイムアウトしました。";     break;
  case WSAECONNRESET:   msg = "接続が切断されました。"; break;
  case WSAECONNABORTED: msg = "接続が切断されました。";       break;
  }
  if (msg) {
