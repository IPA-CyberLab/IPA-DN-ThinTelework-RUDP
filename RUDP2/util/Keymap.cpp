...
const KS2VKEntry SERVER_AUXILIARY_TRANSLATE_TABLE[] = {
  ...
  { XK_Zenkaku_Hankaku,   VK_OEM_AUTO },
  { XK_Zenkaku_Hankaku,   VK_OEM_ENLW },
  { XK_Henkan,            VK_CONVERT },
  { XK_Muhenkan,          VK_NONCONVERT },
  { XK_Hiragana_Katakana, VK_OEM_COPY },
  { XK_Romaji,            VK_OEM_BACKTAB },
  { XK_Katakana,          VK_OEM_FINISH },
};
...
const VK2KSEntry VIEWER_AUXILIARY_TRANSLATE_TABLE[] = {
  ...
  { VK_OEM_AUTO,    XK_Zenkaku_Hankaku },
  { VK_OEM_ENLW,    XK_Zenkaku_Hankaku  },
  { VK_CONVERT,     XK_Henkan },
  { VK_NONCONVERT,  XK_Muhenkan },
  { VK_OEM_COPY,    XK_Hiragana_Katakana },
  { VK_OEM_BACKTAB, XK_Romaji },
  { VK_OEM_FINISH,  XK_Katakana },
