...
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("Thin Telework Server Usermode");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\Thin Telework\\URDP2\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\Thin Telework\\URDP2\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\Thin Telework\\URDP2\\Control\\DispatcherConnectionHistory");
...
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("Thin Telework Server RUDP2");
